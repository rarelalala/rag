...
os.environ["LANGCHAIN_PROJECT"]="qwen-rag-chat"
...
def get_docs(query):
    ...
    # chroma_retriever = vectorstore.as_retriever(search_kwargs={"k": 3}, search_type="mmr")
...
def get_response(query):
    ...
    template = """你是老年人的智能助手，请根据下面提供的信息更加全面且条理清晰地回答问题。
