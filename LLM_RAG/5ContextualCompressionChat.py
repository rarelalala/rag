...
def compressionchat(query):
    ...
    ensemble_retriever = EnsembleRetriever(retrievers=[bm25_retriever, parent_retriever], weights=[0.5, 0.5])
    # 存入向量库，创建retriever
    # vectorstore = Chroma.from_documents(texts_chunks_list, embeddings, persist_directory="db")
